<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Comments_Control.aspx.cs" Inherits="Comments_Control" %>
...
<body style="background:url(Image/background.jpg) center;background-attachment:fixed;background-size:100%;font-weight:bold;">
    ...
    <div style="position:fixed;z-index:1000;left:25%;top:0px;width:50%;height:100%" runat="server">
        ...
        <h2><asp:Label ID="Label1" runat="server" Text=" 请选择您想修改或删除的评论--->" style="position:absolute;top:13px; left:20px;filter:alpha(Opacity=80);-moz-opacity:0.8;opacity: 0.8;"></asp:Label></h2>
        <div style="position:absolute;top:10%;right:0%; width:100%;height:100%">
            <asp:Label ID="Label2" runat="server" Text="评论标题"></asp:Label><br/>
            ...
            <asp:Label ID="Label3" runat="server" Text="评论正文"></asp:Label><br/>
            <asp:Label ID="Label4" runat="server" Text="暂无评论" style="position:absolute;top:30%;right:80%"></asp:Label><br/>
        ...
        <asp:Button ID="Button1" runat="server" Text="删除评论" CssClass="submit"  style="position:absolute;top:84%;right:25%" OnClick="Button1_Click" />
        <asp:Button ID="Button2" runat="server" Text="修改评论" CssClass="submit"  style="position:absolute;top:84%;right:60%" OnClick="Button2_Click"/>
    </div>
